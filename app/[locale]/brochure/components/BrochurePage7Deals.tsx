...
export function BrochurePage7Deals() {
  ...
  return (
    <div className="pdf-page p-12 flex flex-col bg-background relative overflow-hidden">
      ...
      <div className="page-number relative z-10">{tc('page')} 7 {tc('of')} 9</div>
      ...
      <div className="text-center mb-8 relative z-10">
        ...
        <h2 className="text-4xl font-black text-foreground mb-2">{t('deals.title')}</h2>
        <p className="text-base text-muted-foreground font-light">{t('deals.subtitle')}</p>
      </div>

      <div className="grid grid-cols-2 gap-5 flex-1 relative z-10">
        {deals.slice(0, 4).map((deal) => (
          <div key={deal.id} className="group relative bg-background rounded-2xl border-2 border-border overflow-hidden shadow-lg hover:shadow-2xl transition-all hover:border-primary">
            <div className="absolute top-0 left-0 right-0 h-2 bg-gradient-to-r from-primary via-brand-navy to-accent" />
            ...
            <div className="p-5 flex-1">
              ...
              <p className="text-muted-foreground text-xs mb-3 line-clamp-2 leading-relaxed">{deal.description}</p>
                    ...
                    <li key={idx} className="flex items-start text-xs">
                      <div className="flex-shrink-0 mt-0.5 mr-1.5">
                        <div className="p-0.5 bg-brand-gold/20 rounded-full">
                          <Check className="h-2.5 w-2.5 text-brand-gold" />
                        </div>
                      </div>
