...
export function BrochurePage6Membership() {
  ...
  return (
    <div className="pdf-page p-12 flex flex-col bg-gradient-to-br from-brand-navy via-brand-navy/90 to-brand-navy relative overflow-hidden">
      <Image
      ...
      <div className="grid grid-cols-3 gap-5 flex-1 relative z-10">
        <div className="relative group">
          ...
          <div className="relative bg-gradient-to-br from-muted to-muted/90 p-6 rounded-2xl border border-border shadow-2xl flex flex-col h-full">
            <div className="mb-4">
        ...
        <div className="relative group">
          ...
          <div className="relative bg-gradient-to-br from-primary to-primary/90 p-6 rounded-2xl border-2 border-primary-foreground/20 shadow-2xl flex flex-col h-full transform scale-105">
        ...
        <div className="relative group">
          ...
          <div className="relative bg-gradient-to-br from-brand-gold to-brand-light-yellow p-6 rounded-2xl border border-brand-gold shadow-2xl flex flex-col h-full">
            <div className="mb-4">
